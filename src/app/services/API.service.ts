...
export class APIService {
  ...
  getCurrency(currencyKind: any){
    return this.http.get(`https://api.nbp.pl/api/exchangerates/rates/a/${currencyKind}/?format=json`)
  }

  getExchangeRates(){
    return this.http.get('https://v6.exchangerate-api.com/v6/6f7a6339ec22c17f75391f63/latest/EUR/')
  }
}